      ...
      <section class="providers" v-if="auth=='login'">
        ...
        <div class="providers__wrapper">
          <a class="providers__social" href="https://vk.com">
            <img class="providers__image" src="@/assets/images/AuthVKIcon.png" alt="VK icon">
          </a>
          <a class="providers__social" href="https://google.com">
            <img class="providers__image" src="@/assets/images/AuthGoogleIcon.png" alt="Google icon">
          </a>
          <a class="providers__social" href="https://apple.com">
            <img class="providers__image" src="@/assets/images/AuthAppleIcon.png" alt="Apple icon">
          </a>
        </div>
      </section>
    </div>
...
<style lang="scss" scoped>
  .page {
    display: grid;
    min-height: 100vh;
    background-image: url("@/assets/images/AuthPageBackground.avif");
